...
func (p *Unpacker) SetOrder (order binary.ByteOrder) {
	p.order = order
}
...
func (u *Unpacker) ShiftUint16() (uint16, error) {
	...
	return u.order.Uint16(buffer), nil
}
...
func (u *Unpacker) ShiftUint32() (uint32, error) {
	...
	return u.order.Uint32(buffer), nil
}
...
func (u *Unpacker) ShiftUint64() (uint64, error) {
	...
	return u.order.Uint64(buffer), nil
}
...
func (u *Unpacker) ShiftFloat32() (float32, error) {
	...
	return math.Float32frombits(u.order.Uint32(buffer)), nil
}
...
func (u *Unpacker) ShiftFloat64() (float64, error) {
	...
	return math.Float64frombits(u.order.Uint64(buffer)), nil
}
